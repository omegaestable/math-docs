...
\begin{figure}[H]
    ...
    \caption{Curvas solución de una ecuación diferencial. Se muestran las soluciones para $c=1$ y $c=-1$.}
    \label{fig:curvas_solucion}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Recorte2.png}
    \caption{Campo direccional de una ecuación diferencial. Cada segmento muestra la pendiente de la solución en ese punto.}
    \label{fig:campo_direccional}
\end{figure}
...
\begin{ejemplo}
    ...
    \begin{figure}[H]
        ...
        \caption{Campo direccional de la ecuación $y' = -\frac{x}{y}$. Las curvas solución son círculos centrados en el origen.}
        \label{fig:campo_circular}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \caption{Campo direccional de $y' = -\frac{x}{y}$ con isoclinas (rectas que pasan por el origen) superpuestas.}
        \label{fig:isoclinas}
    \end{figure}
\end{ejemplo}
...
\begin{ejemplo}
    ...
    \begin{figure}[H]
        ...
        \caption{Campo direccional de $y' = e^{-x^2}$ con isoclinas verticales.}
        \label{fig:isoclinas_verticales}
    \end{figure}
\end{ejemplo}
...
\begin{ejemplo}
    ...
    \begin{figure}[H]
        ...
        \caption{Campo direccional y curvas integrales de la ecuación $yy' = \cos(x)$.}
        \label{fig:curvas_integrales}
    \end{figure}
\end{ejemplo}
