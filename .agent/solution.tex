...
%==============================================================================
\section{The Harmonic Regularization Property}
%==============================================================================

The Stam inequality admits an elegant reformulation in terms of the efficiency ratio.
...
\]
By Lemma~\ref{lem:fv}, $\eta(p) \ge 1$ with equality iff $n = 2$.
\end{definition}

\begin{theorem}[Harmonic Regularization] \label{thm:harmonic_reg}
...
\]
This is the weighted harmonic mean of $\eta(p)$ and $\eta(q)$ with weights 
$\sigma^2(p)$ and $\sigma^2(q)$.
\end{theorem}

\begin{proof}
Setting $a = \sigma^2(p)$, $b = \sigma^2(q)$, $\alpha = \eta(p)$, $\beta = \eta(q)$,
$\gamma = \eta(p \boxplus_n q)$, and using $\sigma^2(p \boxplus_n q) = a + b$:

The Stam inequality is:
\[
\frac{a+b}{\gamma} \cdot \frac{4}{n(n-1)^2} \ge \frac{a}{\alpha} \cdot \frac{4}{n(n-1)^2} + \frac{b}{\beta} \cdot \frac{4}{n(n-1)^2}.
\]
Simplifying: $\frac{a+b}{\gamma} \ge \frac{a}{\alpha} + \frac{b}{\beta}$.

Rearranging: $\gamma \le \frac{(a+b)\alpha\beta}{a\beta + b\alpha}$, which is the claimed bound.
\end{proof}
...
Fisher information harmonically. The proof rests on three pillars:
